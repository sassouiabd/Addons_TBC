--[[
	...
	Revision: $Id: MatchBeanCount.lua 3384 2008-08-18 20:58:27Z kandoko $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/RC_5.0/BeanCounter/MatchBeanCount.lua $", "$Rev: 3384 $")
