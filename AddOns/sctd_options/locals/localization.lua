...
SCT.LOCALS.OPTION_SLIDER107 = { name="Outgoing Damage Filter", minText="0", maxText="500", tooltipText = "Controls the minimum amount damage needs to be to appear in SCTD. Good for filtering out frequent small hits like Damage Shields, Small DOT's, etc..."};
