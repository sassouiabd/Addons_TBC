...
SCT.OPTIONS.FrameSliders [SCT.LOCALS.OPTION_SLIDER107.name] = { index = 107, SCTVar = "SCTD_DMGFILTER", minValue = 0, maxValue = 500, valueStep = 25, minText=SCT.LOCALS.OPTION_SLIDER107.minText, maxText=SCT.LOCALS.OPTION_SLIDER107.maxText, tooltipText = SCT.LOCALS.OPTION_SLIDER107.tooltipText};
