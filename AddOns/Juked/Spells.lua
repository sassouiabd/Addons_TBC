...
spell_table = {
  ...
  --Paladin
{spellID=1044, time = 25, prio=false}, -- Blessing of Freedom
...
{spellID=642, time=300, prio=false},--Divine Shield
  ...
  --Rogue
{spellID=36554, time=30, prio=false},--Shadowstep 
{spellID=2094, time=90, prio=false},--Blind 
{spellID=26888, time=180, prio=false},--Vanish 
{spellID=14185, time=600, prio=false},--Preparation
{spellID=31224, time=60, prio=false},--Cloak of Shadows (using lowest CD)

--Mage
{spellID=1953, time=15, prio=false}, --Blink
{spellID=31661, time=20, prio=false},--Dragon's Breath
...
{spellID=19386, time=120, prio=false},--Wyvern Sting
{spellID=19263, time=600, prio=false},--Deterrence

--War
{spellID=20252, time = 15, prio=false}, -- Intercept
{spellID=20511, time=180, prio=false},--Intimidating Shout

--Priest
{spellID=8122, time=27, prio=false},--Psychic Scream
{spellID=33206, time=180, prio=false},--Pain Suppression

--Lock
{spellID=6789, time=120, prio=false},--Death Coil
...
-- {spellID=23989, time=300, prio=false},--Readiness
-- {spellID=20594, time=180, prio=false},--Stoneform
-- {spellID=20589, time=105, prio=false},--Escape Artist
-- {spellID=7744, time=120, prio=false},--Will of the Forsaken
-- {spellID=20549, time=120, prio=false},--Warstomp
