...
local spellids = {[12292] = 180, [18499] = 30, [23920] = 10, [6552] = 10, [1766] = 10, [37074] = 3, [25454] = 5, [16979] = 15, [31230] = 60, [31224] = 60, [36554] = 30, [2094] = 90, [19647] = 24, [2139] = 24, [10890] = 23, [10308] = 45}
...
local order = {12292, 18499,  23920, 6552, 1766, 37074, 25454, 16979, 31230, 31224, 36554, 2094, 19647, 2139, 10890, 10308}
...
for _,ability in ipairs(order) do
  if x > 9 * 25 - 45 then y = -30; x = -45 end
...
local function InterruptBar_LoadPosition()
	if InterruptBarDB.Position then
		...
		bar:SetPoint("CENTER", UIParent, "CENTER" , -150, -320)
	end
end
...
local function InterruptBar_OnLoad(self)
	...
	DEFAULT_CHAT_FRAME:AddMessage("Interrupt Bar by Kollektiv. Type /ib for options.",0,1,0)
end
